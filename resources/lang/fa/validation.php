...
return [
    ...
    */
    ...
    "string"           => "فیلد :attribute باید از نوع حروف باشد",
    ...
    */
    'attributes' => [
        ...
        "meta_keywords" => "کلیدواژه های سئو",
        "attribute_id" => "ویژگی",
        "value" => "مقدار",
        "location" => "مکان",
        "deposits" => "ودیعه",
        "mortgages" => "رهن",
        "cover_url1" => "عکس اول ملک",
        "cover_url2" => "عکس دوم ملک",
        "cover_url3" => "عکس سوم ملک",
        "area" => "متراژ",
        "beds" => "تعداد خواب",
        "parking" => "پارکینگ",
        "floor" => "طبقه",
        "warehouse" => "وضعیت انباری",
        "support_id" => "کارشناس",
